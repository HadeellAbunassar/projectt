...
function hideAllProductCategories() {
    const productCategories = document.querySelectorAll(
        ".perfumes, .skincare1, .makeup"
    );
...
const invalidMessage = document.getElementsByClassName("invalid")[0]; // Get the first element with class "invalid"
